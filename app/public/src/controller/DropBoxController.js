class DropBoxController {
    ...
    connectFirebase(){
        var config = {
            apiKey: "AIzaSyDCgy0hqvw1u8-LDv79Df9CzaccTZOROXI",
            authDomain: "dropbox-clone-96376.firebaseapp.com",
            databaseURL: "https://dropbox-clone-96376.firebaseio.com",
            projectId: "dropbox-clone-96376",
            storageBucket: "dropbox-clone-96376.appspot.com",
            messagingSenderId: "991287948752"
        }
    ...
    uploadProgress(event, file){
        ...
        this.timeLeftEl.innerHTML = this.formatTimeToUser(timeLeft)

    }

    formatTimeToUser(duration){
